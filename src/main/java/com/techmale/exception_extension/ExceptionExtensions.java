...
public class ExceptionExtensions<T extends Exception> {
    ...
    public static final ExceptionExtensions<java.awt.AWTException> AWTException = new ExceptionExtensions(java.awt.AWTException.class);
    ...
    public static final ExceptionExtensions<java.awt.color.CMMException> CMMException = new ExceptionExtensions(java.awt.color.CMMException.class);
    ...
    public static final ExceptionExtensions<java.awt.FontFormatException> FontFormatException = new ExceptionExtensions(java.awt.FontFormatException.class);
    ...
    public static final ExceptionExtensions<java.awt.HeadlessException> HeadlessException = new ExceptionExtensions(java.awt.HeadlessException.class);
    ...
    public static final ExceptionExtensions<java.awt.IllegalComponentStateException> IllegalComponentStateException = new ExceptionExtensions(java.awt.IllegalComponentStateException.class);
    ...
    public static final ExceptionExtensions<java.awt.geom.IllegalPathStateException> IllegalPathStateException = new ExceptionExtensions(java.awt.geom.IllegalPathStateException.class);
    ...
    public static final ExceptionExtensions<java.awt.image.ImagingOpException> ImagingOpException = new ExceptionExtensions(java.awt.image.ImagingOpException.class);
    ...
    public static final ExceptionExtensions<java.awt.dnd.InvalidDnDOperationException> InvalidDnDOperationException = new ExceptionExtensions(java.awt.dnd.InvalidDnDOperationException.class);
    ...
    public static final ExceptionExtensions<java.awt.datatransfer.MimeTypeParseException> MimeTypeParseExceptionAwt = new ExceptionExtensions(java.awt.datatransfer.MimeTypeParseException.class);
    ...
    public static final ExceptionExtensions<java.awt.geom.NoninvertibleTransformException> NoninvertibleTransformException = new ExceptionExtensions(java.awt.geom.NoninvertibleTransformException.class);
    ...
    public static final ExceptionExtensions<java.awt.print.PrinterAbortException> PrinterAbortException = new ExceptionExtensions(java.awt.print.PrinterAbortException.class);
    public static final ExceptionExtensions<java.awt.print.PrinterException> PrinterException = new ExceptionExtensions(java.awt.print.PrinterException.class);
    public static final ExceptionExtensions<java.awt.print.PrinterIOException> PrinterIOException = new ExceptionExtensions(java.awt.print.PrinterIOException.class);
    ...
    public static final ExceptionExtensions<java.awt.color.ProfileDataException> ProfileDataException = new ExceptionExtensions(java.awt.color.ProfileDataException.class);
    ...
    public static final ExceptionExtensions<java.awt.image.RasterFormatException> RasterFormatException = new ExceptionExtensions(java.awt.image.RasterFormatException.class);
    ...
    public static final ExceptionExtensions<java.awt.datatransfer.UnsupportedFlavorException> UnsupportedFlavorException = new ExceptionExtensions(java.awt.datatransfer.UnsupportedFlavorException.class);
